package com.piggybank.giftcardservice.controller;
...
public class GiftCardController {
	...
	@PostMapping("/redeem")
	public ResponseEntity<GiftCardDTO> redeemGiftCard(@RequestParam String cardnumber, @RequestParam double Amound) {
		GiftCardDTO updateGiftCard = giftCardService.redeemGiftCard(cardnumber, Amound);
